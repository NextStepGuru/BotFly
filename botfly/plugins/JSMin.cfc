...
<!------------------------------------------- PUBLIC ------------------------------------------->
	...
	<cffunction name="cleanCache" output="false" access="public" returntype="void" hint="Clean the cache location">
		...
		<cfdirectory action="list" directory="#instance.cacheDiskLocation#" name="qList" filter=".js">
		...
		<cfdirectory action="list" directory="#instance.cacheDiskLocation#" name="qList" filter=".css">
