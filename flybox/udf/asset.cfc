component{
	...
	public void function addAssetLibrary(required string library='jquery',required boolean sendToHeader=false,required boolean async=false,required numeric priority=0){
		switch(arguments.library){
			case "formalize":
				//formalize
				addAsset(asset="/flybox/css/formalize/formalize.css",sendToHeader=true,priority=arguments.priority,assetType='css');
				addAsset(asset="/flybox/js/formalize/formalize.js",sendToHeader=false,priority=arguments.priority,assetType='js');
				break;
			case "normalizeCSS":
				//normalizeCSS
				addAsset(asset="/flybox/css/normalize/normalize.css",sendToHeader=true,priority=arguments.priority,assetType='css');
				break;
			case "framelessGrid":
				//framelessGrid
				...
				if(settingExists('framelessGrid_debug') && getSetting('framelessGrid_debug')){
					...
					addAsset(asset="/flybox/js/frameless/frameless.js",sendToHeader=true,priority=arguments.priority,assetType='js');
				}
				break;
			case "jquery":
				//jquery 1.7.1
				addAsset(asset="/flybox/js/jQuery/jQuery.js",sendToHeader=true,priority=arguments.priority);
				break;
			case "jqueryUI":
				//jqueryUI 1.8.16
				addAsset(asset="/flybox/css/jQueryUI/ui-lightness/jquery-ui-1.8.16.custom.css",sendToHeader=arguments.sendToHeader,priority=arguments.priority,assetType='css');
				addAsset(asset="/flybox/js/jQueryUI/jQueryUI.js",sendToHeader=arguments.sendToHeader,priority=arguments.priority);
				break;
			case "jqueryValidate":
				addAsset(asset="/flybox/css/validationEngine/validationEngine.jquery.css",sendToHeader=arguments.sendToHeader,priority=arguments.priority,assetType='css');
				addAsset(asset="/flybox/js/validationEngine/jquery.validationEngine.js",sendToHeader=arguments.sendToHeader,priority=arguments.priority);
				addAsset(asset="/flybox/js/validationEngine/languages/jquery.validationEngine-en.js",sendToHeader=arguments.sendToHeader,priority=arguments.priority);
				break;
			default:
